...
Key Features
  ...
  Hardware Filter:
    ...
    - Supports resolutions up to 1600x900 @ 60 Hz.

    - RGB to Grayscale (Y) conversion pipeline.

    - 5x5 pixel filter window.
  ...
  Hardware: Logsys Kintex-7 FPGA board.

  Tools: Xilinx Vivado & Vitis (2024.2).

  Language:  Verilog HDL for hardware, C for MicroBlaze firmware.
